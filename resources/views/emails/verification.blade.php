        ...
        <div style="display: block;padding: 24px 32px 0;">
            ...
            <div style="margin-bottom: 32px!important;">
                <div style="margin-bottom:32px!important">
                    ...
                    <h3 style="font-size:1.43rem;margin:0!important">It's time to activate your account,</h3>
                    <p>Please press on the button below to activate your account :</p>
                    <a href="{{ env('WEB_URL') }}/verify?token={{ $data ?? '' }}" target="_blank" style="display:block;padding:13px 0;font-size:16px;font-weight:600;line-height:1.38;text-align:center;color:#ffffff;background-color:#1B41AA;border-radius:8px;text-decoration:none;margin:0 auto;max-width:272px">Activate Now</a>
                </div>
            </div>
            <div style="padding:12px 16px;background-color:#e6eaff;border-radius:8px;margin-bottom:16px!important">
                ...
                <p style="margin-top:0!important">The activation only valid for 24 hours. Please do not share this message to anyone.</p>
            </div>
